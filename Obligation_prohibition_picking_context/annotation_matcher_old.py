...
def main():
    ...
    annotation_dir = os.path.join(current_dir, 'data/Police, Crime, Sentencing and Courts Act 2022')
    section_dir = os.path.join(current_dir, 'data/2022/32')
    ...
    # Save to JSON file
    with open('annotations_police.json', 'w', encoding='utf-8') as f:
